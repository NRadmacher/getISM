function mdf = GaussExc2MDF(exc, NA, n0, n, n1, focpos, lamem, mag, av, zpin, atf, kappa, lt, pulse, sat, triplet, fourpi) %, ring)
...
if nargin>16 && ~isempty(fourpi) % 4pi type C microscope
   f0 = f0 + fliplr(f0); 
   f2 = f2 + fliplr(f2);
   f1 = f1 + fliplr(f1);
   g0 = g0 + fliplr(g0);   
