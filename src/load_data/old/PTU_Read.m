function [sync, tcspc, chan, special, num, loc, head] = PTU_Read_old(name, cnts, head)
%
...
rtMultiHarp150T3 = hex2dec('00010307');
    ...
    if cnts(2)>0
        ...
        if fid<1
            ...
            switch head.TTResultFormat_TTTRRecType
                ...
                case {rtHydraHarpT3, rtHydraHarp2T3, rtTimeHarp260NT3, rtTimeHarp260PT3, rtMultiHarp150T3}
...
%         if isfield(head,'HWRoutingChannels')
%             if head.HWRoutingChannels==36
%                 
%                 tr = head.MeasDesc_GlobalResolution;
%                 br = head.MeasDesc_Resolution;
%                 
%                 y     = tr.*sync + br.*tcspc;
%                                 
%                 pulse = unique(sync);
%                 
%                 [pix, bin, num] = PTU_GetPixel(pulse, y, tcspc, chan, special, tr);
%                 
%                 ind     = (pix>0)|(bin<0);
%                 chan    = pix(ind)-1;
%                 sync    = pulse(ind);
